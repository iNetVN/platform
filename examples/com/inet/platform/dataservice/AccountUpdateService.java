 ...
 *
 * @author Duyen Tang
 * @version $Id: AccountUpdateService.java 2015-04-20 11:09:38z tttduyen $
 *
 * @since 1.0
 */
@Named("helloworld_account_update")
@XPortalDataService(roles = { WebConstant.ROLE_USER }, description = "Update account")
@XPortalPageRequest(uri = "helloworld/accounts/update", 
				    inherit = true,
				    transaction = true, 
				    result = WebConstant.ACTION_XSTREAM_JSON_RESULT)
public class AccountUpdateService extends DataServiceMarker {
	@Inject
	...
	protected WebDataService service(AbstractBaseAction action, Map<String, Object> params) throws WebOSBOException 
	{
		...
		// save account
		accountBO.update(account.getUuid(), account);
